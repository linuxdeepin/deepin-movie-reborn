...
void GenerateSettingTranslate()
{
    ...
    auto shortcuts_play_accelName = QObject::tr("Accelerate playback");
    auto shortcuts_play_decelName = QObject::tr("Decelerate playback");
    ...
    auto shortcuts_play_resetName = QObject::tr("Reset play speed");
    auto shortcuts_play_seek_backwardName = QObject::tr("Backward");
    ...
    auto shortcuts_screenshot_screenshotName = QObject::tr("Screenshot");
