 ...
 */
#ifndef _DMR_Platform_SETTINGS_H
#define _DMR_Platform_SETTINGS_H
 ...
 */
class Platform_Settings: public QObject
{
    Q_OBJECT
...
public:
     ...
     * @return 键值
     */
    static QString flag2key(Platform_Settings::Flag f);
...
private:
    ...
    static Platform_Settings *m_pTheSettings;   ///单例唯一实例
};

}

#endif /* ifndef _DMR_Platform_SETTINGS_H */
