 ...
 */
#ifndef _DMR_Platform_NOTIFICATION_WIDGET_H
#define _DMR_Platform_NOTIFICATION_WIDGET_H
 ...
 * 这个类是影院左上角弹窗的类
 */
class Platform_NotificationWidget: public QFrame {
    Q_OBJECT
public:
    enum MessageAnchor {
        ANCHOR_NONE = 0,
     ...
     * @param parent 父窗口
     */
    explicit Platform_NotificationWidget(QWidget *parent = 0);
    /**
...
#endif /* ifndef _DMR_Platform_NOTIFICATION_WIDGET_H */
