...
const CodStdTab codstd_tab[] = {
    ...
    // 	{ STD_VP6,	   AV_ 0, CODEC_ID_VP6,		MKTAG('V', 'P', '6', '0') },
    // 	{ STD_VP6,	   AV_ 0, CODEC_ID_VP6,		MKTAG('V', 'P', '6', '1') },
    // 	{ STD_VP6,	   AV_ 0, CODEC_ID_VP6,		MKTAG('V', 'P', '6', '2') },
    // 	{ STD_VP6,	   AV_ 0, CODEC_ID_VP6F,		MKTAG('V', 'P', '6', 'F') },
    // 	{ STD_VP6,	   AV_ 0, CODEC_ID_VP6F,		MKTAG('F', 'L', 'V', '4') },
