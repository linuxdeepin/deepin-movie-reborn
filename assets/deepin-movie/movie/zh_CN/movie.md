...
> ![notes](../common/notes.svg)说明 ：当鼠标置于进度条上时，默认显示预览窗口。若要关闭预览窗口，请在设备中取消勾选 **鼠标悬停进度条时显示预览**。
...
> ![tips](../common/tips.svg) 窍门： 在播放列表界面，将鼠标指针置于视频文件上，单击![关闭图标](../common/close.svg) 删除视频文件。
