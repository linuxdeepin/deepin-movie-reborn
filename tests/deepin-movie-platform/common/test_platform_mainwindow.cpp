...
TEST(MainWindow, DBus)
{
    ...
    DBusUtils utils;
    QVariant v = Platform_ApplicationAdaptor::readDBusProperty("org.deepin.dde.Audio1", "/org/deepin/dde/Audio1",
    ...
    if (v.isValid()) {
        ...
        for (auto curPath : allSinkInputsList) {
            QVariant name = Platform_ApplicationAdaptor::readDBusProperty("org.deepin.dde.Audio1", curPath.path(),
    ...
    QVariant method = Platform_ApplicationAdaptor::readDBusMethod("org.deepin.dde.Audio1", "/org/deepin/dde/Audio1",
                                                        "org.deepin.dde.Audio1", "SinkInputs");
